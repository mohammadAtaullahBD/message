      ...
      body: ListView(
        children: [
          ListTile(
            ...
            title: const Text('Telegram Bots'),
            subtitle: const Text('Manage bot tokens and chat IDs'),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const TelegramBotsPage()));
            },
          ),
          ListTile(
            leading: const Icon(Icons.rule),
            title: const Text('Forwarding Rules'),
            subtitle: const Text('Auto-forward SMS to Telegram'),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const ForwardingRulesPage()));
            },
          ),
          ListTile(
          ...
          SwitchListTile(
            ...
            onChanged: (val) {
              // To respect the system mode by default, we'd need a ThemeProvider for explicit overrides.
              // For simplicity, we assume system theme is default right now.
              // We'll leave the switch inactive unless a proper Theme provider is added.
...
class TelegramBotsPage extends StatefulWidget {
  const TelegramBotsPage({super.key});
  @override
...
class _TelegramBotsPageState extends State<TelegramBotsPage> {
  ...
  void _showAddBotDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('Add Telegram Bot'),
        content: Column(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Telegram Bots')),
...
class ForwardingRulesPage extends StatefulWidget {
  const ForwardingRulesPage({super.key});
  @override
  State<ForwardingRulesPage> createState() => _ForwardingRulesPageState();
}

class _ForwardingRulesPageState extends State<ForwardingRulesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Forwarding Rules')),
      body: ListView.builder(
